...
namespace DiscordClone.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        public DbSet<ChannelRoom> ChannelRooms { get; set; }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserProfile>(entity =>
            {
                ...
                entity.HasOne(x => x.User)
                      ...
                      .OnDelete(DeleteBehavior.Cascade); // Bezpieczna relacja 1:1
            ...
            modelBuilder.Entity<Message>(entity =>
            {
                ...
                entity.HasMany(x => x.Reactions)
                      .WithOne(r => r.Message)
                      .HasForeignKey(r => r.MessageId)
                      .OnDelete(DeleteBehavior.Cascade); // Reakcje kasują się razem z wiadomością
            });
            ...
            modelBuilder.Entity<MessageReaction>(entity =>
            {
                ...
                // Unikalność: ten sam użytkownik nie może dodać tej samej reakcji 2 razy
            ...
            modelBuilder.Entity<Channel>(entity =>
            {
                ...
                entity.HasOne(x => x.Server)
                      .WithMany(s => s.Channel)
                      .HasForeignKey(x => x.ServerId);

                entity.HasOne(x => x.Friendships)
                      .WithMany(f => f.Channel)
            ...
            modelBuilder.Entity<Friendship>(entity =>
            {
                ...
                // Relacja do User (właściciel friendship)
                entity.HasOne(x => x.User)
                      .WithMany(u => u.Friendships)
                      .HasForeignKey(x => x.UserId)
                      .OnDelete(DeleteBehavior.Restrict);

                // Relacja do Friend (drugi użytkownik) - bez navigation property
            ...
            modelBuilder.Entity<Server>(entity =>
            {
                ...
                entity.HasOne(x => x.User)
                      ...
                      .OnDelete(DeleteBehavior.Restrict); // Zmienione z Cascade dla bezpieczeństwa
            });
