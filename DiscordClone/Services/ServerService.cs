...
namespace DiscordClone.Services
{
    public class ServerService
    {
        ...
        public List<ServerMember> GetServerMembers(int id)
       {
        ...
        //public bool IsServerOwner(int serverId, string userId)
        //{
        //    var UserId = _FriendsService.GetUserIntId(userId);
        //    var server = _context.Servers
        //        .FirstOrDefault(s => s.Id == serverId);
        //    if (server == null || UserId == null) return false;
        //    return server.OwnerId == UserId;
        //}
        //public bool IsServerAdmin(int serverId, string userId)
        //{
        //    var UserId = _FriendsService.GetUserIntId(userId);
        //    if (UserId == null) return false;
        //    var member = _context.ServerMembers
        //        .FirstOrDefault(sm => sm.ServerId == serverId && sm.UserId == UserId);
        //    if (member == null) return false;
        //    return member.Range == Range.Admin || member.Range == Range.Owner;
        //}

        //public bool IsServerModerator(int serverId, string userId)
        //{
        //    var UserId = _FriendsService.GetUserIntId(userId);
        //    if (UserId == null) return false;
        //    var member = _context.ServerMembers
        //        .FirstOrDefault(sm => sm.ServerId == serverId && sm.UserId == UserId);
        //    if (member == null) return false;
        //    return member.Range == Range.Moderator || member.Range == Range.Admin || member.Range == Range.Owner;
        //}

        //public bool IsServerMember(int serverId, string userId)
        //{
        //    var UserId = _FriendsService.GetUserIntId(userId);
        //    if (UserId == null) return false;
        //    var member = _context.ServerMembers
        //        .FirstOrDefault(sm => sm.ServerId == serverId && sm.UserId == UserId && sm.Range == Range.Member);
        //    return member != null;
        //}
    }
}
